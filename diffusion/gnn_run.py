...
from pl_gnn_model import GNNDiModel


def arg_parser():
  parser = ArgumentParser(description='Run a Pytorch-Lightning discriminative gnn model on a MSCO dataset.')
  ...
  parser.add_argument('--project_name', type=str, default='official_infocom25')
...
if __name__ == '__main__':
  ...
  # model = GNNDiModel(param_args=args)
